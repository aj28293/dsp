...
IT/ (FT + IT) = 1/300 /(1/125 + 1/300) = 29.4%
...
Both approaches include evaluating evidence about different hypotheses.  Bayseian uses a probability distribution over the hypotheses and data based on prior data but may require creation of prior data.  Frequentist does not use the probability of hypothesis but depends on likelihood of observed and unobserved data.
